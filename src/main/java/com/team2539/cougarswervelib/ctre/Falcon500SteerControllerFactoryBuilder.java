package com.team2539.cougarswervelib.ctre;

import static com.team2539.cougarswervelib.ctre.CtreUtils.checkCtreError;
...
public final class Falcon500SteerControllerFactoryBuilder {
    ...
    private class FactoryImplementation<T>
        ...
        public ControllerImplementation create(
                Falcon500SteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
