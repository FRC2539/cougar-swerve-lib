...
import com.team2539.cougarswervelib.ctre.*;
import com.team2539.cougarswervelib.rev.NeoDriveControllerFactoryBuilder;
import com.team2539.cougarswervelib.rev.NeoSteerConfiguration;
import com.team2539.cougarswervelib.rev.NeoSteerControllerFactoryBuilder;
...
public final class Mk4iSwerveModuleHelper {
    ...
    private static SteerControllerFactory<?, Falcon500SteerConfiguration<CanCoderAbsoluteConfiguration>>
     ...
     */
    public static SwerveModule createFalcon500(
            GearRatio gearRatio, int driveMotorPort, int steerMotorPort, int steerEncoderPort, double steerOffset) {
        return createFalcon500(
                new Mk4ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset);
    }
